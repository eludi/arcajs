/**********************************************************************************************
*
*   rlgl.noglad - raylib-based modified OpenGL abstraction layer
*
...
*       GL3W        - OpenGL extensions loading (OpenGL 3.3 Core Windows only)
*
*
*   LICENSE: zlib/libpng
*
*   Copyright (c) 2014-2019 Ramon Santamaria (@raysan5)
*   GLAD replaced by GL3W by Gerald Franz (@eludi_net)
*
...
typedef unsigned char byte;
    ...
    typedef struct Mesh {
        ...
        size_t texId;           // diffuse texture2d, addition by GF
    } Mesh;
...
void rlLoadExtensions(void *loader)
{
    ...
    #if !defined(__APPLE__) && !defined(RLGL_NO_GLAD)
