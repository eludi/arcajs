...
"		this.emit('gamepad', {index:index, type:'connect', axes:state.axes.length, buttons:state.buttons.length});\n"
"	}\n"
"\n"
...
"		return this.emit('gamepad', {index:index, type:'axis', axis:axis, value:state.axes[axis]});\n"
"	}\n"
"\n"
...
"			return this.emit('gamepad', {index:index, type:'button', button:i, value:keydown?1:0});\n"
"		}\n"
"	}\n"
"}\n";
