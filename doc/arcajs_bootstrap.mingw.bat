...
curl.exe http://libsdl.org/release/SDL2-devel-2.32.8-mingw.tar.gz -o SDL2-devel-2.32.8-mingw.tar.gz
tar.exe -xf .\SDL2-devel-2.32.8-mingw.tar.gz
ren SDL2-2.32.8 SDL2
cd SDL2
md lib
md lib\win32-x64
